...
<html lang="cs" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="css/charities.css.php">
    <script src="js/charities.js.php" charset="utf-8"></script>
    <script>
  ...
  <body>
    ...
    <div id="statusBar" class="statusbar"><button id="statusBarBackBtn" class="statusBarBackBtn">&lt;</button><span id="subtitleText"></span></div>
